...
class DRNN(nn.Module):
    ...
    def forward(self, x):
        ...
        output = F.tanh(self.h2o1(hiddens[1])) + F.tanh(self.h2o2(hiddens[4])) + F.tanh(self.h2o2(hiddens[-1]))
    ...
    def forecast(self, x):
        ...
        for i in range(d - self.W + 1):
            ...
            output1 = F.tanh(self.h2o1(hiddens[1]))
            output2 = F.tanh(self.h2o2(hiddens[4]))
